...
@property (nonatomic, strong) UIDynamicItemBehavior *quicksand;
...
@property (nonatomic, strong) UIDynamicItemBehavior *blackBlockTracker;
@property (nonatomic, strong) UICollisionBehavior *scoreBoundary;
...
- (void)resumeGame
{
    if (!self.redBlock && !self.blackBlock) {
...
- (void)resetScore
{
    ...
    self.blackBlockTracker = nil;
    self.scoreBoundary=nil;
//    self.scoreBoundaryCenter=nil;
...
- (UIDynamicBehavior *)blackBlockTracker
{
    if (!_blackBlockTracker) {
        UIDynamicItemBehavior *blackBlockTracker = [UIDynamicItemBehavior alloc];
        blackBlockTracker = [blackBlockTracker initWithItems:@[self.blackBlock]];
